...
<body>
  <div class="loginContainer">
    ...
    <form class="form_container" method="POST" action="{{ route('userLogin') }}">
      @csrf
      ...
      <div class="input_container">
        ...
        <input placeholder="name@mail.com" title="Inpit title" name="emailLogin" type="text" class="input_field" id="email_field" required>
      </div>
      <div class="input_container">
        ...
        <input placeholder="Password" title="Inpit title" name="passwordLogin" type="password" class="input_field" id="password_field" required>
      </div>
