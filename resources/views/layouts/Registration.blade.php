...
<body>
  <div class="loginContainer">
    <!-- Adapted from Uiverse.io by zanina-yassine -->
    <form class="form_container" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
    @csrf
      <div class="title_container">
        <p class="title">Create Your Account</p>
        <span class="subtitle">Sign up to get started.</span>
      </div>
      <br>
      <div class="input_container">
        <label class="input_label" for="username_field">Username</label>
        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
          <path stroke="#141B34" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
          <circle cx="12" cy="7" r="4" stroke="#141B34" stroke-width="1.5" fill="none"></circle>
        </svg>
        <input placeholder="YourUsername" title="Username" name="username" type="text" class="input_field" id="username_field" required>
      ...
      <div class="input_container">
        <label class="input_label" for="image_field">Profile Image</label>
        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
        ...
        <input title="Profile Image" name="image" type="file" accept="image/*" class="input_field file_input" id="image_field">
      </div>
      <div class="message">
